...
void loop() {
    ...
    M5.Lcd.print("Btn.1  Btn.2");  // Set the cursor position to (35,10).
                                   // 将光标位置设置为(35,10)
    ...
    if (cur_value1 != last_value1) {
        M5.Lcd.fillRect(20, 25, 45, 40,
                        BLACK);  // Draw a black rectangle 45 by 40 at (20,25).
                                 // 在(20,25)处绘制宽45,高40的黑色矩形
        if (cur_value1 == 0) {
