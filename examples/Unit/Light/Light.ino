...
void loop() {
  ...
  analogRead_value = analogRead(33);  //Store the analog quantity read from pin 33.  将33号引脚读取到的模拟量存储
  digitalRead_value = digitalRead(32);  //Store the number read from pin 32.  将32号引脚读取到的数字量存储
