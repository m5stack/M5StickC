...
void setup() {
  ...
  M5.begin();
  Wire.begin(32,33);
  M5.Lcd.setCursor(30, 5, 2);
  M5.Lcd.println("ACC");

  M5.Lcd.setCursor(3, 30); M5.Lcd.print(" x ");
  M5.Lcd.setCursor(3, 50); M5.Lcd.print(" y ");
  M5.Lcd.setCursor(3, 70); M5.Lcd.print(" z ");
...
void loop() {
  // put your main code here, to run repeatedly:
    if (accel.update()) {
    M5.Lcd.fillRect(35, 30, 50, 15, BLACK);
    M5.Lcd.setCursor(35,  30); M5.Lcd.print((int)(1000*accel.getX()));
     M5.Lcd.fillRect(35, 50, 50, 15, BLACK);
    M5.Lcd.setCursor(35, 50); M5.Lcd.print((int)(1000*accel.getY()));
     M5.Lcd.fillRect(35, 70, 50, 15, BLACK);
    M5.Lcd.setCursor(35, 70); M5.Lcd.print((int)(1000*accel.getZ()));
