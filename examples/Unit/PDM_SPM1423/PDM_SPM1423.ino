...
void microPhoneSetup()
{
    ...
    DisFFTbuff.createSprite(160,59);
}
...
void MicroPhoneFFT()
{
    ...
    DisFFTbuff.fillRect(0,0,160,54,DisFFTbuff.color565(0x00,0x00,0x00));
    ...
    for( int x = 0; x < 24; x++ )
    {
        for( int y = 0; y < 9; y++ )
        {
            ...
            DisFFTbuff.fillRect(x*7,54-y*4 - 5,3,3,colorRect);
        }
    }
    DisFFTbuff.pushSprite(0, 20);
}
