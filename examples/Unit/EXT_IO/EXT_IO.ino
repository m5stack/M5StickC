...
* date：2021/8/30
*******************************************************************************
  Please connect to Port ,Control the 8 extended IOs on the EXT.IO Unit to cycle high and low level changes.
  请连接端口 ,在EXT.IO Unit上控制8个扩展的IO来循环高电平和低电平的变化。
*/
#include <M5StickC.h>
...
void setup()
{
  ...
  ioCon1.twiWrite(32, 33);  //Sets the I2C pin of the connection.  设置连接的I2C引脚
  delay(10);
  res = 1;
  ioCon1.twiRead(res);
  Serial.printf("res:%d\r\n", res);
